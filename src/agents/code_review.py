...
def security_review(state: State):
    ...
    messages = [
        ("system","You are an expert in code security. Focus on identifying vulnerabilities, injection risk, and authentication issues."),
...
def maintainability_review(state: State):
    ...
    messages = [
        ("system","You are and expert in code quality. Focus on code structure, readability, and adherence to best practices"),
        ("user", f"Review this code: {code}")
    ]
