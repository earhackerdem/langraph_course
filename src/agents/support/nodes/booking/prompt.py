...
- get_appointment_availability: Get the availability of medical appointment.

Rules:
- Before to use book_appointment, you must check the availability of the appointment with the get_appointment_availability 
